...
const home_1 = ["9811 La Duke Dr.", "Kensington, MD", 1100000,2500, 4, 3, "home_1.jpg"]
const home_2 = ["843 Marvon St.", "Onalaska, WI", 1100000,2500, 4, 3, "home_2.jpg"]
const home_3 = ["51 East Goldfield Ave.", "West Orange, NJ", 1100000,2500, 4, 3, "home_3.jpg"]
const home_4 =  ["7849 Yukon Lane", "Napa, CA", 1100000,2500, 4, 3, "home_4.jpg"]
const home_5 =  ["31 North Tailwater St.", "Folsom, CA", 1100000,2500, 4, 3, "home_5.jpg"]
const home_6 =  ["7785 Water Street", "San Diego, CA", 1100000,2500, 4, 3, "home_6.jpg"]
const home_7 =  ["9848 Lees Creek Dr.", "Carson, CA", 1100000,2500, 4, 3, "home_7.jpg"]
const home_8 =  ["8014 Pennington St.", "Fresno, CA", 1100000,2500, 4, 3, "home_8.jpg"]
const home_9 =  ["519 Gulf Drive", "Long Beach, CA", 1100000,2500, 4, 3, "home_9.jpg"]
const home_10 =  ["295 Shore Circle", "Anaheim, CA", 1100000,2500, 4, 3, "home_10.jpg"]
const home_11 =  ["9702 Tailwater St.", "Ontario, CA", 1100000,2500, 4, 3, "home_11.jpg"]
const home_12 =  ["166 Joy Ridge Lane", "Tracy, CA", 1100000,2500, 4, 3, "home_12.jpg"]
const home_13 = ["813 Woodland Court", "Huntington Park, CA", 1100000,2500, 4, 3, "home_13.jpg"]
const home_14 =  ["817 Ridgewood St.", "Montebello, CA", 1100000,2500, 4, 3, "home_14.jpg"]
const home_15 =  ["51 High Noon Street.", "Milwaukee, WI", 1100000,2500, 4, 3, "home_15.jpg"]
